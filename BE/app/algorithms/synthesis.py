...
# IEC 故障状态名(与 algorithms/detect/iec.py 对齐)
NORMAL = "Normal"
# 用作"健康基线"的状态名(单一 enum,合成时用)
HEALTHY = NORMAL
...
# 各异常态权重按 EDA 实际占比调整
# 单设备方案下需降低转移概率(避免 360 天内异常过多)
FAULT_TRANSITION_PROBS = {
    "Partial Discharge (Low)": 0.0015,
    "Partial Discharge (High)": 0.0003,
    "Discharge of Low Energy": 0.0012,
    "Discharge of High Energy": 0.0008,
    "Thermal Fault <300℃": 0.0010,
    "Thermal Fault 150-300℃": 0.0014,
    "Thermal Fault 300-700℃": 0.0010,
    "Thermal Fault >700℃": 0.0024,  # 高温过热在 EDA 中占比最高
}
